...
namespace BasicCSharp
{
    public class VariablesAndParameters
    {
        ...
        public void should_initialize_to_default_value()
        {
            ...
            RefTypeClass expectedReferenceTypeValue = null;    // 声明对象为null
        ...
        public void should_get_default_value_using_default_operator()
        {
            ...
            object expectedDefaultObjectResult = null;                     // 声明对象为null
        ...
        public void should_get_copy_of_the_argument_when_passing_by_value_for_ref_type()
        {
            ...
            Assert.Same(expectedResult, refTypeObject);                         // Same 和 Equal
        }
        ...
        public void should_ref_to_same_location_when_passing_by_ref_for_value_type()
        {
            ...
            FunctionPassingRefIntAsArgument(ref passingInt);                    // why ref?
        ...
        public void should_ref_to_same_location_when_passing_by_ref_for_ref_type()
        {
            ...
            RefTypeClass modifiedRefTypeObject = FunctionPassingRefRefTypeClassAsArgument( // 不加ref的话，rTO会指向80行new的对象；加上后会指向83行方法返回的对象
                ref refTypeObject);
        ...
        {
            return values.Sum(i => i);                                          // lambda exp
        }
