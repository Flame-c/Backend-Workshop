...
namespace BasicCSharp
{
    public class NumberOperations
    {
        ...
        public void should_get_correct_type_for_floating_point_number_without_literal()
        {
            ...
            Type guessTheType = typeof(double);                                 // double & Double
        ...
        {
            // change "typeof(string)" to correct type.
            Type guessTheType = typeof(int);                                  // int & Int32
        ...
        {
            // change "typeof(string)" to correct type.
            Type guessTheType = typeof(decimal);                                // decimal & Decimal
        ...
        {
            // change "typeof(string)" to correct type.
            Type guessTheType = typeof(long);                                   // long & Int64
        ...
        {
            // change "typeof(string)" to correct type.
            Type guessTheType = typeof(float);                                  // float & Single
        ...
        public void should_never_count_on_integer_floating_number_casting()
        {
            ...
            const int expectedResult = 100000000;                               // 溢出问题
        ...
        public void should_get_infinite_value_when_divide_by_zero_for_floating_point_number()
        {
            ...
            const double denominator = double.PositiveInfinity;
